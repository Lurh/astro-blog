 ...
 */
export const site = {
  title: 'runhao 的灵光一闪', // required
  favicon: '/favicon-32x32.png', // required
  description: 'Welcome to my independent blog website! ',
  author: "Runhao", // required
  avatar: '/cat.jpg', // required
  url: 'https://blog.runhao.life', // required
  baseUrl: '/', // When using GitHubPages, you must enter the repository name startWith '/'. e.g. '/astro-blog'
  motto: 'Thrive amidst uncertainty.',
  recentBlogSize: 5,
  archivePageSize: 25,
  postPageSize: 10,
  feedPageSize: 20,
...
export const config = {
  ...
  // memos config
  memosUrl: 'https://blog.runhao.life', // https://xxxx.xxx.xx
...
export const donate = {
  ...
  wechatQRCode: "/wxpay.png",
  alipayQRCode: "/alipay.jpg",
